...
Country_HC = ['India', 'Singapore', 'Finland', 'Poland', 'Greece', 'Indonesia', 'Brazil', 'Argentina', 'Mexico',
              'Egypt']
        ...
        while True:
            ...
            if random_word in animals_e:
                ...
                if random_word == 'apple':  # คำใบ้
                    ...
                    print('It is a sweet fruit, often green, with a shape thinner at the top and round at the bottom. ')
